...
//                    binding.fragmentPlanSummary200MaxWordsTv.setTextColor(Color.parseColor("#C4C4C4"))
        ...
        createPlanButton.setOnClickListener {
            ...
            val action = CreatePlanSummaryFragmentDirections.actionCreatePlanSummaryFragment2ToCreatePlanFragment(planDuration, planDescription, businessName, planCategory, businessType)
            findNavController().navigate(action)
        }
    }
}
