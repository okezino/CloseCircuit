    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.fragmentWelcomeLoginBtn.setOnClickListener {
            findNavController().navigate(
               WelcomeScreenFragmentDirections.actionWelcomeScreenFragmentToLoginFragment(),
                customNavAnimation().build())
        }
        // navigate from  welcome screen to create an account
        binding.welcomePageCreateAccountBtn.setOnClickListener {
            findNavController().navigate(
               WelcomeScreenFragmentDirections.actionWelcomeScreenFragmentToCreateAccountFragment(),
                customNavAnimation().build())
        }
    }
