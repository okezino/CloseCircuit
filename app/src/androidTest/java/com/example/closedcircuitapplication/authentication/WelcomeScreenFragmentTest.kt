...
import com.example.closedcircuitapplication.authentication.presentation.ui.screens.WelcomeScreenFragment
...
class WelcomeScreenFragmentTest : TestCase(){
    ...
    fun check_if_Botton_are_responsive(){
        onView(withId(R.id.fragment_welcome_login_btn)).perform(click())
